...
public class Q12CeilAndFloorOfNum {
    public static void ceilAndFloorOfNum(int []arr,int ele){
        int low =0;
    ...
    public static void main(String args[]) {
        ...
        System.out.println("enter the element to find Ceil and Floor of that : ");
        int ele = sc.nextInt();


        ceilAndFloorOfNum(arr,ele);
    }
